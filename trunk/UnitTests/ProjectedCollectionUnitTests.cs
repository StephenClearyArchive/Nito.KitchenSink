...
namespace UnitTests
{
    ...
    public class ProjectedCollectionUnitTests
    {
        ...
        public void TestSimpleProjectionWrite()
        {
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 7 }));
        }
        ...
        public void TestNestedSimpleProjection()
        {
            ...
            ProjectedCollection collection = new ProjectedCollection { SourceCollection = source, Path = "Child.Value" };
        ...
        public void TestBadPath()
        {
            ...
            Assert.IsTrue(collection.Cast<object>().Select(x => (x == null) ? 0 : (int)x).SequenceEqual(new[] { 0 }));
        }
        ...
        public void TestSourceContainingNull()
        {
            ...
            Assert.IsTrue(collection.Cast<object>().Select(x => (x == null) ? 0 : (int)x).SequenceEqual(new[] { 17, 0 }));
        }
        ...
        public void TestPropertyChange()
        {
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 19 }));

            test.Value = 21;

            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 21 }));
        }
        ...
        public void TestAddItem()
        {
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 17, 19 }));

            source.Insert(1, new TestObject { Value = 21 });

            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 17, 21, 19 }));
        }
        ...
        public void TestRemoveItem()
        {
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 17, 19, 21 }));

            source.RemoveAt(1);

            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 17, 21 }));
        ...
        public void TestMoveItem()
        {
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 19, 17, 21 }));
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 21, 17, 19 }));

            source.Move(2, 0);

            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 19, 21, 17 }));
        }
        ...
        public void TestReplaceItem()
        {
            ...
            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 17, 199, 21 }));

            source[2] = new TestObject { Value = 1 };

            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 17, 199, 1 }));

            source[0] = source[2];

            Assert.IsTrue(collection.Cast<int>().SequenceEqual(new[] { 1, 199, 1 }));
        }
