// <copyright file="CRC.cs" company="Nito Programs">
...
namespace Nito.KitchenSink
{
    ...
    /// <summary>
    /// A generalized CRC algorithm.
    /// </summary>
    [CLSCompliant(false)]
    public sealed class CRCImpl<TUnsignedIntegral> : HashAlgorithm
    {
        /// <summary>
        /// The lookup tables for non-reversed polynomials.
        /// </summary>
        private static readonly Dictionary<TUnsignedIntegral, TUnsignedIntegral[]> NormalLookupTables = new Dictionary<TUnsignedIntegral, TUnsignedIntegral[]>(0);
        
        /// <summary>
        /// The lookup tables for reversed polynomials.
        /// </summary>
        private static readonly Dictionary<TUnsignedIntegral, TUnsignedIntegral[]> ReversedLookupTables = new Dictionary<TUnsignedIntegral, TUnsignedIntegral[]>(0);

        /// <summary>
        /// A reference to the lookup table.
        /// </summary>
        private readonly TUnsignedIntegral[] lookupTable;
        ...
        /// </summary>
        private TUnsignedIntegral remainder;
