...
{
    [TestClass]
    public class MultiByteDelimiterFramerUnitTests
    {
        [TestMethod]
        ...
        {
            var framer = new MultipleByteDelimiterFramer(2, Encoding.ASCII.GetBytes("<beg>"), Encoding.ASCII.GetBytes("<end>"));
        ...
        public void CompleteMessage_IsAccepted()
        {
            ...
            framer.MessageArrived += (x) => message1 = Encoding.ASCII.GetString(x.ToArray());
        ...
        public void CompleteMessages_AreAccepted()
        {
            ...
            framer.MessageArrived += (x) => { if (message1 == null) message1 = Encoding.ASCII.GetString(x.ToArray()); else message2 = Encoding.ASCII.GetString(x.ToArray()); };
        ...
        private MultipleByteDelimiterFramer CreateFramer()
        {
            return new MultipleByteDelimiterFramer(0, Encoding.ASCII.GetBytes("<beg>"), Encoding.ASCII.GetBytes("<end>"));
        }
    }
}
