...
namespace Nito.Weakness
{
    ...
    public interface IWeakKeyDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IWeakCollection<KeyValuePair<TKey, TValue>>
    {
    }
    ...
    /// <typeparam name="TValue">The type of the value.</typeparam>
    public sealed class WeakKeyDictionary<TKey, TValue> : IWeakKeyDictionary<TKey, TValue> where TKey : class
    {
        /// <summary>
        ...
        {
            this.dictionary = dictionary.SelectKey(x => x.TargetAs<TKey>(), x => ObjectTracker.Default.TrackObject(x));
        }
